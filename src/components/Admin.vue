        ...
        <tr>
          <td align="center" style="padding: 24px; background: #333;">
            <table width="600" cellpadding="0" cellspacing="0" border="0" style="background-color: #fff;">
              ...
              <tr>
                <td><img src="../assets/photos/phone.jpg" style="width: 100%; object-fit: cover;" alt="Phone Image"></td>
              </tr>
              <tr>
                <td style="width: 100%; padding: 24px 12px; text-align: start; background: #fff; color: #333; box-sizing: border-box;">
                  Добрый день ${chiefname}.<br><br>
              ...
              <tr>
                <td style="width: 100%; padding: 12px; background: #fff; box-sizing: border-box;">
                  <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td width="50%" style="padding: 12px;"><img src="../assets/photos/webdevelop.jpg" style="width: 100%; object-fit: cover; border-radius: 16px; box-shadow: 2px 2px 8px 0px rgba(0, 0, 0, .3);" alt="Web Development"></td>
                      <td width="50%" style="padding: 12px; text-align: start; line-height: 100%; font-weight: 600;">
                        Разработку современного Web сайта для вашей ${orgname}<br><br>
                    ...
                    <tr>
                      ...
                      <td width="50%" style="padding: 12px;"><img src="../assets/photos/mobileapp.jpg" style="width: 100%; object-fit: cover; border-radius: 16px; box-shadow: 2px 2px 8px 0px rgba(0, 0, 0, .3);" alt="Mobile App"></td>
                    </tr>
                    <tr>
                      <td width="50%" style="padding: 12px;"><img src="../assets/photos/crm.jpg" style="width: 100%; object-fit: cover; border-radius: 16px; box-shadow: 2px 2px 8px 0px rgba(0, 0, 0, .3);" alt="CRM"></td>
                      <td width="50%" style="padding: 12px; text-align: start; line-height: 100%; font-weight: 600;">
              ...
              <tr>
                <td align="center" style="padding: 12px; background: #fff; color: #333;">
                  <img src="../assets/photos/gift.jpg" style="width: 80%; object-fit: cover; border-radius: 32px; box-shadow: 2px 2px 8px 0px rgba(0, 0, 0, .3);" alt="Gift">
